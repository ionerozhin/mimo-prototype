        ...
        <table style={{ borderCollapse: "separate", borderSpacing: 0, minWidth: fixedColsWidth + visibleMonths.length * COL_WIDTHS.month, width: "100%", tableLayout: "fixed" }}>
          ...
          <tfoot>
            <tr>
              ...
              {visibleMonths.map(function(vm) { var isCur = vm.key === SCHEDULED_MONTH; return <td key={vm.key} style={{ ...footerCellStyle, textAlign: "right", background: isCur ? T.colorSurfaceSecondary : T.colorSurfacePrimary }}>{totalAdditions[vm.key] ? fmtAddition(totalAdditions[vm.key]) : "-"}</td>; })}
            </tr>
            <tr>
              <td style={{ ...footerCellStyle, ...stickyCol0 }} colSpan={1}>Total releases</td>
              <td style={{ ...footerCellStyle }} colSpan={4}></td>
              {visibleMonths.map(function(vm) { var isCur = vm.key === SCHEDULED_MONTH; return <td key={vm.key} style={{ ...footerCellStyle, textAlign: "right", background: isCur ? T.colorSurfaceSecondary : T.colorSurfacePrimary }}>{totalReleases[vm.key] ? fmtRelease(totalReleases[vm.key]) : "-"}</td>; })}
            </tr>
            <tr>
              ...
              {visibleMonths.map(function(vm) {
                ...
                return (
                  <td key={vm.key} style={{ ...footerCellStyle, textAlign: "right", background: isCur ? T.colorSurfaceSecondary : T.colorSurfacePrimary }}>
              ...
              <table style={{ borderCollapse: "separate", borderSpacing: 0, minWidth: _dpFixedColsWidth + _dpVisibleMonths.length * _dpColWidths.month, width: "100%", tableLayout: "fixed" }}>
                ...
                <tbody>{_dpFilteredData.map(item => (
                  <tr key={item.id} onMouseEnter={e => { e.currentTarget.style.background = T.colorSurfaceSecondary; e.currentTarget.querySelectorAll("[data-sticky]").forEach(td => { td.style.background = T.colorSurfaceSecondary; }); }} onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.querySelectorAll("[data-sticky]").forEach(td => { td.style.background = T.colorSurfacePrimary; }); }}>
                    ...
                    {_dpVisibleMonths.map(vm => { const isCur = vm.key === _dpScheduledMonth; return (<td key={vm.key} style={{ ..._dpCellStyle, textAlign: "right", background: isCur ? T.colorSurfaceSecondary : T.colorSurfacePrimary }}>{_dpRenderMonthCell(item, vm.key)}</td>); })}
                  </tr>
                ))}</tbody>
                <tfoot>
                  <tr><td style={{ ..._dpFooterCellStyle, ..._dpStickyCol0 }} colSpan={1}>Total additions</td><td style={{ ..._dpFooterCellStyle }} colSpan={5}></td>{_dpVisibleMonths.map(vm => { const isCur = vm.key === _dpScheduledMonth; return (<td key={vm.key} style={{ ..._dpFooterCellStyle, textAlign: "right", background: isCur ? T.colorSurfaceSecondary : T.colorSurfacePrimary }}>{_dpTotalAdditions[vm.key] ? _dpFmtGBP(_dpTotalAdditions[vm.key]) : "-"}</td>); })}</tr>
                  <tr><td style={{ ..._dpFooterCellStyle, ..._dpStickyCol0 }} colSpan={1}>Total depreciation</td><td style={{ ..._dpFooterCellStyle }} colSpan={5}></td>{_dpVisibleMonths.map(vm => { const isCur = vm.key === _dpScheduledMonth; return (<td key={vm.key} style={{ ..._dpFooterCellStyle, textAlign: "right", background: isCur ? T.colorSurfaceSecondary : T.colorSurfacePrimary }}>{_dpTotalDep[vm.key] ? "(" + _dpFmtGBP(_dpTotalDep[vm.key]) + ")" : "-"}</td>); })}</tr>
                  <tr><td style={{ ..._dpFooterCellStyle, ..._dpStickyCol0 }} colSpan={1}>Total disposals</td><td style={{ ..._dpFooterCellStyle }} colSpan={5}></td>{_dpVisibleMonths.map(vm => { const isCur = vm.key === _dpScheduledMonth; return (<td key={vm.key} style={{ ..._dpFooterCellStyle, textAlign: "right", background: isCur ? T.colorSurfaceSecondary : T.colorSurfacePrimary }}>{_dpTotalDisposals[vm.key] ? _dpFmtGBP(_dpTotalDisposals[vm.key]) : "-"}</td>); })}</tr>
                  <tr><td style={{ ..._dpFooterCellStyle, ..._dpStickyCol0 }} colSpan={1}>Closing NBV</td><td style={{ ..._dpFooterCellStyle }} colSpan={5}></td>{_dpVisibleMonths.map(vm => { const isCur = vm.key === _dpScheduledMonth; return (<td key={vm.key} style={{ ..._dpFooterCellStyle, textAlign: "right", background: isCur ? T.colorSurfaceSecondary : T.colorSurfacePrimary }}>{_dpFmtGBP(_dpClosingNBVs[vm.key] || 0)}</td>); })}</tr>
                </tfoot>
              </table>
            </div>
          </div>
