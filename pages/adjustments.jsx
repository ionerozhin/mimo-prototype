...
function AccruedIncomeSchedulePage({ open, onClose, activeScheduleType, onScheduleTypeChange, suggestionsCount, sugCards, reviewState, reviewTitle, addLabel, onRunReview, onReviewStateChange, viewMode, onToggleMode, adjComments = {}, onAddAdjComment }) {
  ...
  const _aiData = [
    ...
    { id: 2, description: "Sublease rent – Warehouse unit B", dateRange: "Mar 26", status: "Active", balanceForward: null, toAllocate: null, accruedAmount: 1950.00, toReverse: 1000.00, revenueAccount: "4200 – Rental income", entries: function() { const e = {}; e[_aiMonthKey(2, 2026)] = { addition: 1950.00, status: "published" }; e[_aiMonthKey(3, 2026)] = { reversal: 950.00, status: "scheduled" }; return e; }(), },
  ...
  const _aiColWidths = { description: 300, revenueAccount: 220, balance: 200, accruedAmount: 160, month: 140 };
              ...
              <td data-sticky="1" style={{ ..._aiCellStyle, ..._aiStickyCol0 }}>
                <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  ...
                  {item.isSuggestion ? (
                    ...
                    <span style={{ display: "inline-flex", alignItems: "center", alignSelf: "flex-start", background: T.colorInfoBg, color: T.colorInfo, borderRadius: 4, padding: "2px 8px", fontSize: 12, fontWeight: 500, lineHeight: "17px", whiteSpace: "nowrap" }}>{_aiFmtGBP(item.toReverse)} to reverse</span>
                  ) : (
                    <span style={{ ...T.textXs, color: T.colorTextSecondary }}>{item.dateRange}</span>
                  )}
                </div>
              </td>
