...
const PATHS = {
  ...
  starAi: "M9.99984 1.66669L11.6765 6.02592C11.9115 6.63695 12.029 6.94246 12.2117 7.19944C12.3737 7.4272 12.5727 7.6262 12.8004 7.78815C13.0574 7.97088 13.3629 8.08838 13.9739 8.32339L18.3332 10L13.9739 11.6767C13.3629 11.9117 13.0574 12.0292 12.8004 12.2119C12.5727 12.3738 12.3737 12.5728 12.2117 12.8006C12.029 13.0576 11.9115 13.3631 11.6765 13.9741L9.99984 18.3334L8.32321 13.9741C8.0882 13.3631 7.97069 13.0576 7.78796 12.8006C7.62601 12.5728 7.42702 12.3738 7.19926 12.2119C6.94228 12.0292 6.63677 11.9117 6.02574 11.6767L1.6665 10L6.02574 8.32339C6.63677 8.08838 6.94228 7.97088 7.19926 7.78815C7.42702 7.6262 7.62601 7.4272 7.78796 7.19944C7.97069 6.94246 8.0882 6.63695 8.32321 6.02592L9.99984 1.66669Z",
};
...
function NavIcon({ name, color }) {
  ...
  if (name === "starAi") return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path d={PATHS.starAi} fill={color || T.colorBrandPrimary} stroke={color || T.colorBrandPrimary} strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
...
// ── Banner — Contextual notification banner ────────────────────────────────
// Copied from design-system-v3/Banner.jsx
function Banner(props) {
  ...
  var defaultIcon = React.createElement("svg", { width: 16, height: 16, viewBox: "0 0 16 16", fill: "none", style: { flexShrink: 0, marginTop: 2 } },
  ...
  var handleDismiss = function() { setDismissed(true); if (onDismiss) onDismiss(); };
  ...
  return React.createElement("div", {
    ...
    action && React.createElement("button", {
      ...
      style: {
        ...
        cursor: "pointer", fontSize: 12, fontWeight: 500, color: v.color,
